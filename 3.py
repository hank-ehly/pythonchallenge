...
raw_data = """kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
...
matches = re.findall(r'[a-z][A-Z]{3}[a-z][A-Z]{3}[a-z]', raw_data)
# ['qIQNlQSLi', 'eOEKiVEYj', 'aZADnMCZq', 'bZUTkLYNg', 'uCNDeHSBj', 'kOIXdKBFh', 'dXJVlGZVm', 'gZAGiLQZx', 'vCJAsACFl', 'qKWGtIDCj']:

hidden_message = list()
for idx, match in enumerate(matches):
    hidden_message.insert(idx, match[4])

hidden_message = ''.join(map(str, hidden_message))
